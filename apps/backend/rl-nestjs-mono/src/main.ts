...
import {EventsGateway} from './app/notifications/gateway/events/events.gateway';
...
async function bootstrap() {
  ...
  const notificationsEventsGateway = app.get(EventsGateway);
  setInterval(() => notificationsEventsGateway.sendMessage(), 1000);
}
